...
//Диалог.
define('THEME_DIALOG_BEGIN',                    '<table class="table_frame_backgrounds" style="width:{WIDTH}">');

define('THEME_DIALOG_BEGINAUTH',                    '<table class="table_frame_auth" style="width:{WIDTH}">');

define('THEME_DIALOG_BACKGROUNDS',                    '<table class="table_frame_backgrounds" style="width:{WIDTH}">');

define('THEME_DIALOG_BACKGROUNDW',                    '<table class="table_frame_backgroundw" style="width:{WIDTH}">');

define('THEME_DIALOG_END',                      '</table>');

define('THEME_DIALOG_TITLE',                    '<tr><td colspan="{COLUMNS_COUNT}" class="sexy_list_title" align="left">{TEXT}</td></tr>');

define('THEME_DIALOG_TITLEAUTH',                    '<tr><td colspan="{COLUMNS_COUNT}" class="sexy_list_titleauth" align="center">{TEXT}</td></tr>');


define('THEME_DIALOG_GROUP_BEGIN',              '<td colspan="{COLUMNS_COUNT}" valign="top"><table class="table_frame_backgroundw" width="100%">');

define('THEME_DIALOG_GROUP_BEGINAUTH',              '<td colspan="{COLUMNS_COUNT}" valign="top"><table class="table_frame_auth" width="100%">');
...
define('THEME_DIALOG_ITEM_LISTBOX_BEGIN',       '<select id="{NAME}" class="sexy_list" name="{NAME}" style="width:120px; height: 14px">');
...
define('THEME_DIALOG_ITEM_TEXT_BOLD',           '<td align="left" class="sexy_dialog_text" >{TEXT}</td>');
...
define('THEME_DIALOG_ITEM_INPUT_TEXT',          '<td><input type="text" class="sexy_text" name="{NAME}" value="{VALUE}" maxlength="{MAX}" style="width:{WIDTH}" /></td>');

define('THEME_DIALOG_ITEM_INPUT_AUTH',          '<td><input type="text" class="sexy_text_auth" name="{NAME}" value="{VALUE}" maxlength="{MAX}" style="width:{WIDTH}" /></td>');

define('THEME_DIALOG_ITEM_INPUT_AUTHP',          '<td><input type="password" class="sexy_text_auth" name="{NAME}" value="{VALUE}" maxlength="{MAX}" style="width:{WIDTH}" /></td>');
...
define('THEME_DIALOG_ITEM_ACTION_SUBMIT',       '<input type="submit" class="sexy_submit" value="{TEXT}"{JS_EVENTS} />');

define('THEME_DIALOG_ITEM_ACTION_AUTH',       '<input type="submit" class="sexy_auth" value="{TEXT}"{JS_EVENTS} />');

define('THEME_DIALOG_ITEM_ACTION_SUBMITMINI',       '<input type="submit" class="sexy_msubmit" value="{TEXT}"{JS_EVENTS} />');

define('THEME_DIALOG_ITEM_ACTIONMINI',              '<input type="button" class="sexy_maction" value="{TEXT}"{JS_EVENTS} />');


define('THEME_DIALOG_ITEM_ACTION_RESET',        '<input type="reset" class="sexy_reset" value="{TEXT}"{JS_EVENTS} />');
define('THEME_DIALOG_ITEM_ACTION',              '<input type="button" class="sexy_action" value="{TEXT}"{JS_EVENTS} />');
...
define('THEME_LIST_FRAME',                       '<table class="sexy_frame_list" style="width:{WIDTH}">');

define('THEME_LIST_FRAME2',                       '<table class="sexy_frame_list2" style="width:{WIDTH}">');

define('THEME_LIST_END',                         '</table>');
define('THEME_LIST_TITLE',                       '<tr><td colspan="{COLUMNS_COUNT}" align="left" class="sexy_list_title">{TEXT}</td></tr>');
...
define('THEME_LIST_ITEM_INFO_L1',               '<td class="sexy_list_infol1" align="left" style="width:{WIDTH}">{TEXT}</td>');
define('THEME_LIST_ITEM_INFO_L2',               '<td class="sexy_list_infol2" align="left" style="width:{WIDTH}">{TEXT}</td>');

define('THEME_LIST_ITEM_INFO_L3',               '<td colspan="{COLUMNS_COUNT}" class="sexy_list_infol3" align="left" style="width:{WIDTH}"><pre>{TEXT}</pre></td>');


define('THEME_LIST_ITEM_INF_L1',               '<td class="sexy_list_infl1" align="left" style="width:{WIDTH}">{TEXT}</td>');
define('THEME_LIST_ITEM_INF_L2',               '<td class="sexy_list_infl2" align="left" style="width:{WIDTH}">{TEXT}</td>');


define('THEME_LIST_ITEM_INFO_R1',               '<td class="sexy_list_infor1" align="right" style="width:{WIDTH}">{TEXT}</td>');
define('THEME_LIST_ITEM_INFO_R2',               '<td class="sexy_list_infor2" align="right" style="width:{WIDTH}">{TEXT}</td>');
