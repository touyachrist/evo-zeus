...
define('LNG_REPORTS', 'Jabber уведомления');

define('LNG_REPORTS_OPTIONS',          'Настройки');
define('LNG_REPORTS_OPTIONS_ENABLE',   'Включить уведомления');
define('LNG_REPORTS_OPTIONS_ACCOUNT',  'Аккаунт (name@server[:port]):');
define('LNG_REPORTS_OPTIONS_PASSWORD', 'Пароль:');
define('LNG_REPORTS_OPTIONS_TO',       'Получатель (name@server):');
...
define('LNG_REPORTS_E2', 'Не верно указан получатель.');
