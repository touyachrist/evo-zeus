...
define('LNG_REPORTS_BOTSACTION', 'Выполнить действие:');
...
define('LNG_REPORTS_FILTER_GROUPQUERY', 'Исключить повтор отчетов.');
define('LNG_REPORTS_FILTER_NONAMES',    'Не отображать имена ботов.');
...
define('LNG_REPORTS_DATE_EMPTY',     'Соответствующих дате отчетов нет.');
define('LNG_REPORTS_DATE_NOREPORTS', 'Соответствующих фильтру отчетов нет.');
