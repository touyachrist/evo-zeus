...
$mainMenu = array(      //Модуль.             //Название.               //Необходимые права.
				  ...
				  array('bank_statistics',    LNG_MM_SYSTEM_INFO,            array()),
...
function showLoginForm($showError)
{
  ...
  str_replace('{WIDTH}', 'auto', THEME_DIALOG_BEGINAUTH).
    str_replace(array('{COLUMNS_COUNT}', '{TEXT}'), array(2, 'Login'), THEME_DIALOG_TITLEAUTH).
    THEME_DIALOG_ROW_BEGIN.
      str_replace('{COLUMNS_COUNT}', 1, THEME_DIALOG_GROUP_BEGINAUTH).
        THEME_DIALOG_ROW_BEGIN.
          str_replace('{TEXT}', 'User name:', THEME_DIALOG_ITEM_TEXT).
          str_replace(array('{VALUE}', '{NAME}', '{MAX}', '{WIDTH}'), array('', 'user', '255', '200px'), THEME_DIALOG_ITEM_INPUT_AUTH).
        THEME_DIALOG_ROW_END.
        THEME_DIALOG_ROW_BEGIN.
          str_replace('{TEXT}', 'Password:', THEME_DIALOG_ITEM_TEXT).
          str_replace(array('{VALUE}', '{NAME}', '{MAX}', '{WIDTH}'), array('', 'pass', '255', '200px'), THEME_DIALOG_ITEM_INPUT_AUTHP).
        THEME_DIALOG_ROW_END.
        THEME_DIALOG_ROW_BEGIN.
          str_replace('{TEXT}', 'Sec. pass:', THEME_DIALOG_ITEM_TEXT).
          str_replace(array('{VALUE}', '{NAME}', '{MAX}', '{WIDTH}'), array('', 'secpass', '255', '200px'), THEME_DIALOG_ITEM_INPUT_AUTHP).
        THEME_DIALOG_ROW_END.
        THEME_DIALOG_ROW_BEGIN.
    ...
    str_replace('{COLUMNS_COUNT}', 2, THEME_DIALOG_ACTIONLIST_BEGIN).
      str_replace(array('{TEXT}', '{JS_EVENTS}'), array('Sing In', ''), THEME_DIALOG_ITEM_ACTION_AUTH).
    THEME_DIALOG_ACTIONLIST_END.
  THEME_DIALOG_END;
